...
const SYSTEM_PROMPT = `Ты — копирайтер и маркетолог для эзотерических экспертов (тарологов, астрологов, нумерологов).
...
3. ТЕКСТ КЕЙСА (развёрнутый, 300-400 слов):
   ...
   **СДЕЛАЛИ** (1-2 абзаца):
   ...
   - Какие методы использовали (таро, астрология, нумерология и т.д.)
