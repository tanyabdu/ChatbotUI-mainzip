...
СТИЛЬ ПИСЬМА (по принципам нейрокопирайтинга Дениса Каплунова):
1. Пиши как говоришь — простым, живым языком. Представь, что объясняешь подруге за чашкой чая.
2. Короткие предложения. Максимум 15-20 слов в предложении. Никаких длинных абзацев.
3. ЗАПРЕЩЕНО использовать:
   - Канцеляризмы: "осуществлять", "производить", "в рамках", "на основании"
   - Сложные обороты: "в связи с тем, что", "принимая во внимание"
   - Штампы: "уникальный", "эксклюзивный", "незабываемый", "волшебный мир"
   - Пустые слова: "данный", "определённый", "соответствующий", "непосредственно"
4. ИСПОЛЬЗУЙ:
   - Конкретику: цифры, факты, примеры из жизни
   - Эмоции: страх, надежда, любопытство, облегчение
   - Вопросы к читателю
   - Метафоры из повседневной жизни
5. Каждое предложение должно нести смысл. Убирай воду.
6. Начинай с боли или желания читателя, не с себя.

ПЛОХО (так НЕ пиши):
"В рамках данной консультации вы получите уникальную возможность осуществить глубинное погружение в тайны Вселенной и обрести непосредственное понимание своего предназначения."

ХОРОШО (пиши ТАК):
"Ты застряла. Чувствуешь это? Каждый день как предыдущий. На консультации разберём, что тебя держит — и как сдвинуться с места. Конкретно. Без воды."`;
...
export async function generateSingleFormat(input: SingleFormatInput): Promise<FormatContent> {
  ...
  const writingRules = `
СТИЛЬ (нейрокопирайтинг):
- Пиши как говоришь. Короткими предложениями. Максимум 15 слов.
- НЕЛЬЗЯ: "уникальный", "волшебный", "в рамках", "осуществлять", "данный"
