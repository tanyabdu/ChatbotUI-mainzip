...
export async function generateIdeasOnly(input: ContentGenerationInput): Promise<ContentIdea[]> {
  ...
  const systemPrompt = `Ты — креативный стратег контента для эзотерических практиков.
Твоя задача: придумать УНИКАЛЬНЫЕ цепляющие идеи для постов.

🎲 SEED ГЕНЕРАЦИИ: ${randomSeed}
📌 ФОКУС НА КАТЕГОРИИ: ${selectedCategories}

⚠️ КРИТИЧЕСКИ ВАЖНО:
- Каждая генерация должна быть АБСОЛЮТНО УНИКАЛЬНОЙ
- НЕ ПОВТОРЯЙ стандартные темы типа "какой картой ты был в прошлой жизни"
- Придумывай СВЕЖИЕ, НЕОЖИДАННЫЕ углы на боли аудитории

🎯 БОЛИ ЦЕЛЕВОЙ АУДИТОРИИ (выбирай разные при каждой генерации!):
...
- разрыв, развод, расставание
- любовный треугольник

💰 ДЕНЬГИ И КАРЬЕРА:
- нет клиентов/заработка
- страх больших денег
- синдром самозванца
- не могу поднять цены
- выгорание от работы
- не знаю своё призвание

🌟 САМОРЕАЛИЗАЦИЯ:
- застряла на одном месте
- живу не свою жизнь
- страх изменений
- нет энергии на мечты
- откладываю жизнь на потом
...
ПРАВИЛА ДЛЯ ИДЕЙ:
- Бей в КОНКРЕТНУЮ боль, а не в абстракцию
- Формулируй как заголовок, который НЕВОЗМОЖНО пролистать
- Используй любопытство: "Что на самом деле...", "Почему никто не говорит..."
- Избегай банальщины типа "Сила Луны" или "Магия таро"${archetypeInstruction}`;
...
Примеры ХОРОШИХ (но НЕ КОПИРУЙ их дословно!):
- "Клиентка пришла с вопросом о муже. А проблема оказалась в маме"
- "Почему расклады врут? 3 ошибки, которые делают даже опытные"
- "Она заплатила 50к и исчезла. История со счастливым концом"

Для каждого дня:
- day: номер
- idea: УНИКАЛЬНАЯ цепляющая формулировка (1-2 предложения)
- type: тип (Экспертный/Личная история/Продающий/Вовлекающий)

⚠️ Генерируй РАЗНЫЕ темы, не повторяй одну и ту же боль!
...
Примеры ХОРОШИХ (но НЕ КОПИРУЙ их дословно!):
- "Почему твоя мама влияет на твои отношения больше, чем ты думаешь"
- "3 слова, которые отталкивают деньги. Проверь, говоришь ли ты их"
- "Тест: какой твой саботажник по дате рождения?"
...
⚠️ Генерируй РАЗНЫЕ темы из разных категорий болей!
