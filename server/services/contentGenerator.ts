...
Пример: [{"day":1,"idea":"Она пришла с вопросом про мужа. А ушла с новой работой","type":"Продающий","post":{"content":"Клиентка записалась на расклад про отношения.\\n\\nНо карты показали другое: пора менять работу. Она не верила.\\n\\nЧерез 2 недели ей предложили должность мечты. Совпадение?\\n\\n→ Записывайся на расклад. Ссылка в шапке профиля","hashtags":["#таро","#консультациятаро"]},"carousel":{"content":"Слайд 1: Она спросила про мужа.\\nА карты показали работу.\\n\\nСлайд 2: История Марины, 34 года...\\n\\nСлайд 7: Хочешь узнать, что карты покажут тебе?\\nЗапись в директ 💌","hashtags":["#таро"]},"reels":{"content":"Хук (0-3 сек): Она спросила про мужа. Карты показали другое.\\n\\nОснова: История Марины...\\n\\nПризыв: Хочешь свой расклад? Ссылка в шапке","hashtags":["#таро"]},"stories":{"content":"Сторис 1: Расскажу историю клиентки. Такое редко бывает...\\n\\nСторис 2: Она пришла с вопросом про мужа...\\n\\nСторис 3: Карты показали РАБОТУ. Она не поверила.\\n\\nСторис 4: Через 2 недели — оффер мечты!\\n\\nСторис 5: Хочешь узнать, что карты скажут тебе? Напиши 'хочу расклад'","hashtags":["#таро"]}}]${archetypeInstruction}`;
...
Формат: ТОЛЬКО JSON массив.
Пример: [{"day":1,"idea":"90% не знают этого про свой знак. А это меняет ВСЁ","type":"Вовлекающий","post":{"content":"Твой знак зодиака — это только 20% тебя.\\n\\nЕсть ещё Луна, Венера, Асцендент...\\n\\nНапиши свой знак — расскажу главную ошибку, которую делают 90% твоего знака 👇","hashtags":["#астрология","#знакизодиака"]},"carousel":{"content":"Слайд 1: Главная ошибка твоего знака\\n(Сохрани — пригодится!)\\n\\nСлайд 2: ♈ Овен\\nТоропишься. Начинаешь 10 дел, заканчиваешь 2.\\n\\nСлайд 3: ♉ Телец...","hashtags":["#астрология"]},"reels":{"content":"Хук (0-3 сек): Стоп! Если ты делаешь ЭТО — твой знак тебя предупреждает!\\n\\nОснова (3-20 сек): Каждый знак имеет слепое пятно...\\n\\nПризыв: Напиши свой знак — скажу твоё!","hashtags":["#астрология"]},"stories":{"content":"Сторис 1: Опрос: Веришь в астрологию? Да/Скорее да/Нет\\n\\nСторис 2: А знаешь главную ошибку своего знака?\\n\\nСторис 3: Смотри карусель — там разбор всех знаков!\\n\\nСторис 4: Напиши в директ свой знак — дам персональный совет","hashtags":["#астрология"]}}]${archetypeInstruction}`;
