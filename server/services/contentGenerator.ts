...
Структура каждого элемента: {"day":1,"idea":"[УНИКАЛЬНАЯ идея на основе ПРОДУКТА]","type":"[тип]","post":{"content":"[текст]","hashtags":["#тег"]},"carousel":{"content":"Слайд 1: [заголовок]...","hashtags":["#тег"]},"reels":{"content":"Хук: [3 сек]\\nОснова: [20 сек]\\nПризыв: [действие]","hashtags":["#тег"]},"stories":{"content":"Сторис 1: [текст]...","hashtags":["#тег"]}}
...
Формат: ТОЛЬКО JSON массив.
Структура каждого элемента: {"day":1,"idea":"[УНИКАЛЬНАЯ идея — придумай НОВУЮ каждый раз]","type":"[тип]","post":{"content":"[текст]","hashtags":["#тег"]},"carousel":{"content":"Слайд 1: [заголовок]...","hashtags":["#тег"]},"reels":{"content":"Хук: [3 сек]\\nОснова: [20 сек]\\nПризыв: [действие]","hashtags":["#тег"]},"stories":{"content":"Сторис 1: [текст]...","hashtags":["#тег"]}}
...
🎯 ОБЯЗАТЕЛЬНО ИСПОЛЬЗУЙ ОПИСАНИЕ ПРОДУКТА В КАЖДОЙ ИДЕЕ:
"${product || 'консультация'}"

Каждая идея должна:
- Бить в КОНКРЕТНУЮ боль клиентки
- Связывать боль с ПРОДУКТОМ специалиста
- Быть УНИКАЛЬНОЙ — не повторяй одни и те же формулировки

⛔ НЕ пиши про профессию специалиста, техники для коллег!
✅ Пиши про ЖИЗНЕННЫЕ БОЛИ клиенток и как ПРОДУКТ их решает!
...
Каждая идея должна:
- Бить в КОНКРЕТНУЮ боль клиентки
- Быть ВОВЛЕКАЮЩЕЙ — вызывать желание комментировать/сохранять
- Быть УНИКАЛЬНОЙ — не повторяй одни и те же формулировки
