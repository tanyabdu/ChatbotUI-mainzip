...
Пример структуры: [{"day":1,"idea":"Почему он не пишет? На консультации выяснилась неожиданная причина","type":"Продающий","post":{"content":"Она пришла с вопросом: 'Почему он замолчал?'\\n\\nДумала — разлюбил. На консультации выяснилось другое: он боится серьёзных отношений.\\n\\nЧерез неделю он вернулся. Сам.\\n\\n→ Хочешь понять, что происходит в твоих отношениях? Ссылка в шапке","hashtags":["#отношения","#консультация"]},"carousel":{"content":"Слайд 1: Он замолчал. Что делать?\\n\\nСлайд 2: История клиентки...\\n\\nСлайд 7: Хочешь разобраться?\\nЗапись в директ","hashtags":["#отношения"]},"reels":{"content":"Хук: Он не пишет? Вот почему.\\n\\nОснова: 3 причины мужского молчания...\\n\\nПризыв: Напиши — разберём твою ситуацию","hashtags":["#отношения"]},"stories":{"content":"Сторис 1: Опрос: Он замолкал без причины?\\n\\nСторис 5: Хочешь понять? Пиши 'хочу'","hashtags":["#отношения"]}}]
...
Формат: ТОЛЬКО JSON массив.
Пример структуры: [{"day":1,"idea":"Устала от отношений, где ты даёшь больше, чем получаешь?","type":"Вовлекающий","post":{"content":"Ты отдаёшь. Он принимает.\\n\\nТы стараешься. Он — нет.\\n\\nЗнакомо? Это не он плохой. Это паттерн.\\n\\nНапиши в комментариях — узнаёшь себя? 👇","hashtags":["#отношения","#психология"]},"carousel":{"content":"Слайд 1: Почему ты притягиваешь тех, кто не ценит?\\n\\nСлайд 2: Причина 1: Ты сильная. Притягиваешь слабых.\\n\\nСлайд 3: Причина 2: Ты терпеливая. Слишком.","hashtags":["#отношения"]},"reels":{"content":"Хук: Устала быть удобной?\\n\\nОснова: 3 причины, почему ты притягиваешь тех, кто не ценит...\\n\\nПризыв: Напиши — узнала себя?","hashtags":["#отношения"]},"stories":{"content":"Сторис 1: Опрос: Даёшь больше, чем получаешь?\\n\\nСторис 4: Напиши — расскажу, как это изменить","hashtags":["#отношения"]}}]
...
export async function generateIdeasOnly(input: ContentGenerationInput): Promise<ContentIdea[]> {
  ...
  const systemPrompt = `Ты — креативный SMM-стратег. Ты пишешь контент ОТ ЛИЦА специалиста в нише "${niche}" ДЛЯ ЕГО КЛИЕНТОК.

🎲 SEED ГЕНЕРАЦИИ: ${randomSeed}
📌 ФОКУС НА КАТЕГОРИИ: ${selectedCategories}

═══════════════════════════════════════
👩 ЦЕЛЕВАЯ АУДИТОРИЯ — КЛИЕНТКИ СПЕЦИАЛИСТА:
═══════════════════════════════════════
- Женщины 25-45 лет с ОБЫЧНЫМИ жизненными проблемами
- НЕ коллеги-практики из той же ниши
- Это потенциальные КЛИЕНТЫ, которым нужна помощь специалиста

⛔ ЗАПРЕЩЕНО (это B2B-темы для коллег!):
- Темы про обучение профессии
- "Ошибки начинающих специалистов"
- "Как стать экспертом в нише"
- Техники и методики для коллег
- Любые темы ПРО ПРОФЕССИЮ специалиста
...
ПРАВИЛА:
- Пиши про КЛИЕНТКУ и её боль, не про профессию специалиста
- Бей в КОНКРЕТНУЮ проблему жизни
- Формулируй так, чтобы клиентка узнала СЕБЯ
- Используй любопытство: "Почему он..." / "Что мешает тебе..."
- СТРОГО используй терминологию и методы из ниши "${niche}", НЕ добавляй элементы из других ниш${archetypeInstruction}`;

  const userPrompt = goal === "sale"
    ? `SEED: ${randomSeed}
Придумай ${days} УНИКАЛЬНЫХ идей для ПРОДАЮЩЕГО контента.
Контент ОТ ЛИЦА специалиста в нише "${niche}" ДЛЯ его потенциальных КЛИЕНТОК.
НИША: ${niche}
ПРОДУКТ: "${product || 'консультация'}"
ФОКУС: ${selectedCategories}

Примеры ХОРОШИХ идей (про КЛИЕНТОК и их боли!):
- "Она пришла с вопросом про мужа. А проблема оказалась в её маме"
- "Почему деньги уходят сквозь пальцы. История клиентки с долгами"
- "Клиентка думала, что проблема в муже. На консультации выяснилось другое"

⛔ НЕ пиши про профессию специалиста, техники для коллег!
✅ Пиши про ЖИЗНЕННЫЕ БОЛИ клиенток!
⚠️ СТРОГО используй только терминологию ниши "${niche}", НЕ добавляй элементы из других ниш (таро, астрология и т.д. если это не указано в нише)!
...
Примеры ХОРОШИХ идей (про КЛИЕНТОК и их боли!):
- "Почему ты притягиваешь мужчин, которые не ценят?"
...
ЧЕКЛИСТ:
✓ Начни с КОНКРЕТНОЙ боли клиентки
...
ЗАПРЕЩЕНО:
❌ Абстракции без конкретики что делать
❌ Пустые обещания
...
ПРИМЕР СТРУКТУРЫ:
Почему ты устаёшь к вечеру

---

Причина 1: Делаешь слишком много для других
Ты тратишь энергию на всех, кроме себя.

---

Причина 2: Нет границ
Соглашаешься на всё, даже когда не хочешь.

---

Напиши мне — разберём твою ситуацию`,
