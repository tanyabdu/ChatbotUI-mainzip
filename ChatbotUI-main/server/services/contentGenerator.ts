...
ФОРМАТЫ КОНТЕНТА (ОБЯЗАТЕЛЬНО чередуй!):
- Пост — текстовый пост с изображением
- Сторис — серия сторис (3-5 слайдов)
- Рилс — короткое видео со сценарием

Формат: ТОЛЬКО JSON массив с двойными кавычками.
Пример: [{"day":1,"title":"Заголовок","type":"Продающий","format":"Пост","content":"Текст...\\n\\nЗаписывайтесь в директ!","hashtags":["#тег1","#тег2"]}]${archetypeInstruction}`;
...
Формат: ТОЛЬКО JSON массив с двойными кавычками.
Пример: [{"day":1,"title":"Заголовок","type":"Вовлекающий","format":"Рилс","content":"Сценарий: Привет!...\\n\\nНапишите в комментариях!","hashtags":["#тег1","#тег2"]}]${archetypeInstruction}`;
...
Форматы публикаций (ЧЕРЕДУЙ!):
- Пост — текстовый пост для ленты
- Сторис — серия сторис (укажи 3-5 слайдов)
- Рилс — короткое видео (напиши сценарий)

Ответь ТОЛЬКО JSON массивом с полями: day, title, type, format, content, hashtags.`
...
ОБЯЗАТЕЛЬНЫЕ ТРЕБОВАНИЯ:
1. Создай ровно ${days} постов
2. Чередуй типы: Экспертный, Личная история, Вовлекающий (вопросы), Развлекательный
3. КАЖДЫЙ пост заканчивай призывом к взаимодействию:
   - "Напишите в комментариях..."
   - "Сохраняйте!"
   - "Отметьте подругу"
4. Текст 2-3 абзаца, 3-5 хэштегов
5. Форматы публикаций (ЧЕРЕДУЙ!):
   - Пост — текстовый пост для ленты
   - Сторис — серия сторис (укажи 3-5 слайдов)
   - Рилс — короткое видео (напиши сценарий)
