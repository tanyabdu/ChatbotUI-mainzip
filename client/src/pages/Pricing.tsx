  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-pink-50 to-white">
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="mt-12 text-center text-purple-500 text-sm space-y-2">
          <p>Есть вопросы? Напишите нам: klimova@magic-content.ru</p>
          <a href="https://t.me/magic_content_help" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-purple-500 hover:text-purple-700 transition-colors">
            ...
            Служба поддержки в мессенджере «Телеграм»
          </a>
        </div>
      </div>
    </div>
